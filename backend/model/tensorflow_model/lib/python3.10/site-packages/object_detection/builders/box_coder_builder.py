...
def build(box_coder_config):
  ...
  #print(box_coder_config)
  #print(box_coder_config.WhichOneof('box_coder_oneof'))
  #print(getattr(box_coder_config, box_coder_config.WhichOneof('box_coder_oneof')).value)
